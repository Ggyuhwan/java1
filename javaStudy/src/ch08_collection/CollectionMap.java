...
public class CollectionMap {
	...
	public static void main(String[] args) {
		...
		// 첫번째 String <-- 키의 타입, 두번째 String value타입
		HashMap<String, String> stuMap = new HashMap<String, String>();
		// 첫번쨰 String <-- 키의 타입, 두번째 int value 타입
		...
		System.out.println(stuMap.containsKey("첫째")); //트루
		System.out.println(stuMap.containsValue("길동"));//펄스
		//.remove("키") 삭제
		stuMap.remove("둘째");
		System.out.println(stuMap);
